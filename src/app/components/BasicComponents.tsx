          ...
          <div className="bg-white dark:bg-[#2d2d2d] rounded-none border border-[#E5E5E5] dark:border-[#404040] p-6">
            <div className="max-w-md">
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-[#E5E5E5] dark:border-[#404040] bg-white dark:bg-[#1a1a1a] text-[#000000] dark:text-white placeholder-[#848484] dark:placeholder-gray-500 focus:outline-none focus:border-[#5461a6] dark:focus:border-[#93c5fd] transition-colors resize-vertical"
                style={{ fontFamily: "Switzer, sans-serif", borderRadius: "4px" }}
              />
            </div>
          </div>
